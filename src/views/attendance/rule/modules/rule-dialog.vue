...
<script setup lang="ts">
  ...
  const rules = reactive({
    ...
    workInTime: [{ required: true, message: '请选择上班时间', trigger: 'change' }],
    workOutTime: [{ required: true, message: '请选择下班时间', trigger: 'change' }],
    flexibleTimeRange: [{ required: true, message: '请输入弹性时间', trigger: 'blur' }]
  })
